...
var AnimatedCard = ({
  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.createElement("h3", { style: {
      fontSize: "16px",
      fontWeight: "700",
      color: "#fff",
      margin: "0 0 8px"
    ...
    } }, /* @__PURE__ */ React2.createElement("svg", { width: "12", height: "12", viewBox: "0 0 15 15", fill: "none", stroke: "#fff", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React2.createElement("path", { d: "M8.5 1.5L14 7m0 0l-5.5 5.5M14 7H1" })))
  );
};
...
var Card = ({
  ...
  return /* @__PURE__ */ React4.createElement(
    ...
    /* @__PURE__ */ React4.createElement("h3", { style: {
      fontSize: "18px",
      fontWeight: "700",
      color: "#fff",
      margin: "0 0 12px",
    ...
    /* @__PURE__ */ React4.createElement("p", { style: {
      fontSize: "14px",
      color: "rgba(255,255,255,0.65)",
      lineHeight: "1.6",
      margin: "0"
    } }, description),
    hovered && hoverEffect && /* @__PURE__ */ React4.createElement("div", { style: {
      position: "absolute",
      inset: "0",
      borderRadius: radius,
...
function Navbar() {
  ...
  return /* @__PURE__ */ React5.createElement("nav", { className: "w-full bg-slate-900 border-b border-slate-800 text-white" }, /* @__PURE__ */ React5.createElement("div", { className: "w-full max-w-7xl mx-auto px-6 lg:px-8" }, /* @__PURE__ */ React5.createElement("div", { className: "h-20 flex items-center justify-between" }, /* @__PURE__ */ React5.createElement(
    "a",
    {
      href: "#",
      className: "flex items-center flex-shrink-0"
    },
    /* @__PURE__ */ React5.createElement("div", { className: "w-10 h-10 rounded-xl bg-cyan-400/10 border border-cyan-400/30 flex items-center justify-center mr-3 shadow-lg shadow-cyan-400/10" }, /* @__PURE__ */ React5.createElement(
      "svg",
      {
    ...
    /* @__PURE__ */ React5.createElement("span", { className: "text-xl font-bold tracking-tight whitespace-nowrap" }, "Nova", /* @__PURE__ */ React5.createElement("span", { className: "text-cyan-400" }, "UI"))
  ), /* @__PURE__ */ React5.createElement("div", { className: "hidden md:flex items-center ml-auto mr-10" }, links.map((link, index) => /* @__PURE__ */ React5.createElement(
    "a",
    {
      key: link.label,
      href: link.href,
    ...
    link.label
  ))), /* @__PURE__ */ React5.createElement("div", { className: "hidden md:flex items-center flex-shrink-0" }, /* @__PURE__ */ React5.createElement(
    "button",
    {
      type: "button",
  ...
  )), mobileMenuOpen && /* @__PURE__ */ React5.createElement("div", { className: "md:hidden border-t border-slate-800 py-6" }, /* @__PURE__ */ React5.createElement("div", { className: "flex flex-col" }, links.map((link) => /* @__PURE__ */ React5.createElement(
    "a",
    {
      key: link.label,
      href: link.href,
    ...
    link.label
  )), /* @__PURE__ */ React5.createElement("div", { className: "h-px bg-slate-800 my-4" }), /* @__PURE__ */ React5.createElement(
    "button",
    {
      type: "button",
      className: "\n                  py-3\n                  text-left\n                  text-base\n                  font-medium\n                  text-slate-300\n                  hover:text-white\n                  transition-colors duration-200\n                "
...
var PasswordStrengthMeter = ({ password = "", width = "300px" }) => {
  ...
  return /* @__PURE__ */ React6.createElement("div", { style: { width, fontFamily: "system-ui,sans-serif" } }, /* @__PURE__ */ React6.createElement("div", { style: { height: "6px", borderRadius: "3px", background: "rgba(255,255,255,0.07)", overflow: "hidden", position: "relative", marginBottom: "10px" } }, /* @__PURE__ */ React6.createElement("div", { style: { width: strength / 5 * 100 + "%", height: "100%", background: colors[strength], borderRadius: "3px", transition: "width 0.3s ease" } })), /* @__PURE__ */ React6.createElement("div", { style: { display: "flex", alignItems: "center", gap: "8px", fontSize: "14px", color: "rgba(255,255,255,0.8)", fontWeight: "500" } }, /* @__PURE__ */ React6.createElement("span", { style: { fontSize: "18px" } }, emojis[strength]), strength === 0 && "Very Weak", strength === 1 && "Weak", strength === 2 && "Fair", strength === 3 && "Good", strength === 4 && "Strong"));
};
...
var ProductCard = ({
  ...
  const [wishlisted, setWishlisted] = useState6(false);
  const alpha = (hex, op) => {
    const r = parseInt(hex.slice(1, 3), 16), g = parseInt(hex.slice(3, 5), 16), b = parseInt(hex.slice(5, 7), 16);
    return "rgba(" + r + "," + g + "," + b + "," + op + ")";
  };
  return /* @__PURE__ */ React7.createElement(
    ...
    /* @__PURE__ */ React7.createElement("div", { style: { position: "relative", padding: "16px" } }, discount > 0 && /* @__PURE__ */ React7.createElement("div", { style: {
      position: "absolute",
      top: "12px",
      left: "12px",
      padding: "4px 8px",
      ...
      fontWeight: "700",
      zIndex: 1
    } }, "-", discount, "%"), /* @__PURE__ */ React7.createElement(
      "button",
      {
        onClick: () => {
      ...
      /* @__PURE__ */ React7.createElement("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: wishlisted ? accent : "none", stroke: wishlisted ? accent : "#fff", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React7.createElement("path", { d: "M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" }))
    ), /* @__PURE__ */ React7.createElement("div", { style: { width: "100%", height: "200px", position: "relative", overflow: "hidden", borderRadius: "12px" } }, /* @__PURE__ */ React7.createElement(
      "img",
      {
        src: image,
        alt: title,
    ...
    /* @__PURE__ */ React7.createElement("div", { style: { padding: "0 16px 16px" } }, /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" } }, /* @__PURE__ */ React7.createElement("h3", { style: { fontSize: "16px", fontWeight: "700", color: "#fff", margin: 0 } }, title), /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", alignItems: "center", gap: "4px" } }, /* @__PURE__ */ React7.createElement("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "#f59e0b", stroke: "#f59e0b", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }, /* @__PURE__ */ React7.createElement("polygon", { points: "12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" })), /* @__PURE__ */ React7.createElement("span", { style: { fontSize: "13px", color: "rgba(255,255,255,0.8)" } }, rating), /* @__PURE__ */ React7.createElement("span", { style: { fontSize: "11px", color: "rgba(255,255,255,0.4)" } }, "(", reviews, ")"))), /* @__PURE__ */ React7.createElement("p", { style: { fontSize: "13px", color: "rgba(255,255,255,0.6)", margin: "0 0 12px", lineHeight: 1.5 } }, description), /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React7.createElement("div", { style: { display: "flex", alignItems: "baseline", gap: "6px" } }, /* @__PURE__ */ React7.createElement("span", { style: { fontSize: "18px", fontWeight: "800", color: accent } }, currency, price.toFixed(2)), discount > 0 && /* @__PURE__ */ React7.createElement("span", { style: { fontSize: "13px", color: "rgba(255,255,255,0.4)", textDecoration: "line-through" } }, currency, (price * (100 / (100 - discount))).toFixed(2))), /* @__PURE__ */ React7.createElement(
      "button",
      {
        onClick: onAddToCart,
        style: {
...
var ProfileCard = ({
  ...
  const [followed, setFollowed] = useState7(initialFollowed);
  const [msgHovered, setMsgHovered] = useState7(false);
  const handleFollow = () => {
    setFollowed((f) => !f);
  ...
  return /* @__PURE__ */ React8.createElement(
    ...
    /* @__PURE__ */ React8.createElement("div", { style: { padding: "0 20px 20px", marginTop: "-45px" } }, /* @__PURE__ */ React8.createElement(
      "img",
      {
        src: avatar,
        alt: name,
    ...
    ), /* @__PURE__ */ React8.createElement("div", { style: { marginTop: "12px" } }, /* @__PURE__ */ React8.createElement("h3", { style: { margin: 0, fontSize: "18px", fontWeight: 700, color: "#111827" } }, name), /* @__PURE__ */ React8.createElement("p", { style: { margin: "2px 0", fontSize: "14px", color: accentColor, fontWeight: 600 } }, role), /* @__PURE__ */ React8.createElement("p", { style: { margin: 0, fontSize: "13px", color: "#6b7280" } }, location)), /* @__PURE__ */ React8.createElement(
      "p",
      {
        style: {
          fontSize: "13px",
      ...
      tags.map((tag, i) => /* @__PURE__ */ React8.createElement(
        "span",
        {
          key: i,
          style: {
      ...
      stats.map((stat, i) => /* @__PURE__ */ React8.createElement("div", { key: i, style: { textAlign: "center" } }, /* @__PURE__ */ React8.createElement("p", { style: { margin: 0, fontSize: "16px", fontWeight: 700, color: "#111827" } }, stat.value), /* @__PURE__ */ React8.createElement("p", { style: { margin: 0, fontSize: "12px", color: "#9ca3af" } }, stat.label)))
    ), /* @__PURE__ */ React8.createElement("div", { style: { display: "flex", gap: "8px" } }, /* @__PURE__ */ React8.createElement(
      "button",
      {
