...
// ----------------------------------------------------------------------
// 1. Dynamic Live Component Preview (Executes raw JSX string)
// ----------------------------------------------------------------------
...
// 5. Sidebar Component
// ----------------------------------------------------------------------
function SidebarComponent({ selected, search, setSearch, components, onSelect }) {
  return (
...
export default function AllComponents() {
  ...
  // Filter public library components safely
